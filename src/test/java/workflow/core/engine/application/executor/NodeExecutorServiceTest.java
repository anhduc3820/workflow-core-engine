...
class NodeExecutorServiceTest {
  ...
  @Mock private NodeHandler mockHandler;
  ...
  void shouldSelectFirstMatchingEdgeForXORGateway() {
    ...
    // When
    List<GraphEdge> selected =
        nodeExecutorService.selectEdges(gateway, List.of(edge1, edge2), variables);
  ...
  void shouldSelectAllEdgesForParallelGateway() {
    ...
    // When
    List<GraphEdge> selected =
        nodeExecutorService.selectEdges(gateway, List.of(edge1, edge2, edge3), variables);
  ...
  void shouldSelectDefaultEdgeWhenNoXORConditionsMatch() {
    ...
    // When
    List<GraphEdge> selected =
        nodeExecutorService.selectEdges(gateway, List.of(edge1, defaultEdge), variables);
