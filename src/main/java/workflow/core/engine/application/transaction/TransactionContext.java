...
/** Transaction Context Encapsulates all context needed for financial-grade transaction execution */
@Data
@Builder
public class TransactionContext {
  ...
  @Builder.Default private Integer isolationLevel = TransactionDefinition.ISOLATION_SERIALIZABLE;

  @Builder.Default private int timeoutSeconds = 30;

  @Builder.Default private boolean nullResultForbidden = true;

  @Builder.Default private boolean idempotencyRequired = true;
  ...
  @Builder.Default private Map<String, Object> inputData = new HashMap<>();
