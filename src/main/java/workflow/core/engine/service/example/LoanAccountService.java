...
/**
 * Example service bean for loan account creation This demonstrates how service tasks invoke Spring
 * beans
 */
@Slf4j
...
public class LoanAccountService {
  ...
  /** Create loan account This method is invoked by SERVICE_TASK nodes */
