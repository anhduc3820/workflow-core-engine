...
/** Drools rule execution service Loads and executes .drl files */
@Slf4j
@Service
public class DroolsService {
   ...
   */
  public Map<String, Object> executeRules(
      String ruleFile, String ruleflowGroup, Map<String, Object> input) {
    try {
