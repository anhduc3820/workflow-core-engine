...
public class WorkflowController {
  ...
  /** Get all active workflows GET /api/workflows */
  @GetMapping
  ...
  /** Get workflow by ID GET /api/workflows/{workflowId} */
  ...
  /** Deploy workflow from JSON POST /api/workflows/deploy */
  @PostMapping("/deploy")
  ...
  /** Validate workflow JSON without deploying POST /api/workflows/validate */
  ...
  /** Execute workflow POST /api/workflows/{workflowId}/execute */
  ...
  public ResponseEntity<ExecutionResponse> execute(
    ...
    try {
      ...
      response.setSuccess(
          context.getState() == workflow.core.engine.model.ExecutionState.COMPLETED);
  ...
  /** Undeploy workflow DELETE /api/workflows/{workflowId} */
  @DeleteMapping("/{workflowId}")
  public ResponseEntity<UndeployResponse> undeploy(
      @PathVariable String workflowId, @RequestParam String version) {
