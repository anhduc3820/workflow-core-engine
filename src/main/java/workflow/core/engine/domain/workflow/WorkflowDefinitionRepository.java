...
/**
 * Repository: Workflow Definition (v2) Provides persistence operations for workflow definitions
...
public interface WorkflowDefinitionRepository
  ...
  Optional<WorkflowDefinitionEntity> findByWorkflowIdAndVersionAndTenantId(
      String workflowId, String version, String tenantId);

  /** Find all versions of a workflow (v2) */
  List<WorkflowDefinitionEntity> findByWorkflowIdAndTenantIdOrderByDeployedAtDesc(
