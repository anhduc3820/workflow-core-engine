...
/**
 * Domain Entity: Workflow Definition (v2)
 * Represents a deployed workflow template that can be instantiated
 * Supports multi-tenancy and versioning
 */
@Entity
@Table(name = "workflow_definitions",
       uniqueConstraints = @UniqueConstraint(name = "uk_workflow_definition_id_version",
...
public class WorkflowDefinitionEntity {
    ...
    public WorkflowDefinitionEntity(String workflowId, String version, String name, String definitionJson, String tenantId) {
        this.workflowId = workflowId;
        this.version = version;
        this.name = name;
        this.definitionJson = definitionJson;
