...
/**
 * Domain Entity: Node Execution Record Tracks individual node execution within a workflow instance
...
public class NodeExecutionEntity {
  ...
  public NodeExecutionEntity(
      WorkflowInstanceEntity workflowInstance, String nodeId, String nodeType) {
