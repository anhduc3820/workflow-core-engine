...
/**
 * Financial-Grade Execution Event Entity
 * Immutable event log for deterministic replay
 *
 * Every execution step is recorded as an event
 * Events are ordered by sequence number
 * No events can be modified or deleted (immutability guaranteed by domain logic)
 */
@Entity
...
public class ExecutionEventEntity {
    ...
    public ExecutionEventEntity(String executionId, Long sequenceNumber, ExecutionEventType eventType) {
