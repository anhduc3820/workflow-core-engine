...
/**
 * Domain Entity: Version Migration Log (v2) Tracks workflow version migrations for audit and
 * rollback purposes
 */
@Entity
@Table(
    name = "version_migration_log",
    indexes = {@Index(name = "idx_version_migration_workflow_id", columnList = "workflow_id")})
@Data
@NoArgsConstructor
