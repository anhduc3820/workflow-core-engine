...
/**
 * Handler for SERVICE_TASK nodes
 * Invokes Spring beans by service name
 */
@Slf4j
@Component
...
public class ServiceTaskHandler implements NodeHandler {
    ...
    public void execute(GraphNode node, WorkflowContext context) throws NodeExecutionException {
        ...
        try {
            ...
            throw new NodeExecutionException(node.getId(),
                    "Failed to execute service task: " + e.getMessage(), e);
        }
    }
    ...
    private Map<String, Object> invokeServiceMethod(Object serviceBean, String methodName,
